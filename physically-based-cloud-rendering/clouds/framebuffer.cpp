	...
	height{ height }
{
	...
	if (depth)
	{
		...
		glFramebufferTexture2D(gl::GLenum::GL_FRAMEBUFFER, gl::GLenum::GL_DEPTH_ATTACHMENT, gl::GLenum::GL_TEXTURE_2D, depth_and_stenctil_texture->id, 0);
	}
...
{
	glBindFramebuffer(gl::GL_FRAMEBUFFER, id);
}
